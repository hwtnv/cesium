...
click: function () { closeClicked.raiseEvent(this); }');
        ...
        frame.setAttribute('sandbox', 'allow-pointer-lock allow-scripts allow-top-navigation allow-same-origin allow-popups allow-forms'); //allow-pointer-lock allow-scripts allow-top-navigation
